...
//     char menuPrintout[Menu::MAX_ENTRIES * (MenuEntry::MAX_NAME_LENGTH + 5)] = {0};
...
//     const MenuEntry const* getCurrEntry() const    {        return _currentEntry;    }
...
// template <typename TClass>
// const char *Menu<TClass>::getPrintMenu()
// {

//     memset(menuPrintout, 0, sizeof(menuPrintout));
...
//         {
//             strcat(menuPrintout, "> ");
//             strcat(menuPrintout, cur->getDescription());
//             strcat(menuPrintout, " <\n");
//             // printf("> %s <\n",cur->getDescription());
//         }
//         else if (!cur->isActive())
//         {
//             strcat(menuPrintout, "xx ");
//             strcat(menuPrintout, cur->getDescription());
//             strcat(menuPrintout, "\n");
//             // printf("xx %s\n",cur->getDescription());
//         }
